...
export default {
  ...
  methods: {
    ...
    deleteUser ( id ) {
      let self = this;
      let userId = id;
      axios.post( this.$apiAdress + '/api/admin/users/' + id + '?token=' + localStorage.getItem("api_token"), {
        _method: 'DELETE'
      })
    ...
    getUsers (){
      let self = this;
      axios.get( this.$apiAdress + '/api/admin/users?token=' + localStorage.getItem("api_token"))
      .then(function (response) {
