...
export default {
  ...
  methods: {
    ...
    deleteRole ( id ) {
      let self = this;
      let noteId = id;
      axios.post(   this.$apiAdress + '/api/admin/roles/' + id + '?token=' + localStorage.getItem("api_token"), {
        _method: 'DELETE'
      })
    ...
    moveUp( id ){
      let self = this;
      axios.get(   this.$apiAdress + '/api/admin/roles/move/move-up?id=' + id + '&token=' + localStorage.getItem("api_token"))
      .then(function (response) {
    ...
    moveDown( id ){
      let self = this;
      axios.get(   this.$apiAdress + '/api/admin/roles/move/move-down?id=' + id + '&token=' + localStorage.getItem("api_token"))
      .then(function (response) {
          self.message = 'Successfully move role.';
          self.showAlert();
          self.getRoles();
    ...
    getRoles (){
      let self = this;
      axios.get(   this.$apiAdress + '/api/admin/roles?token=' + localStorage.getItem("api_token") )
      .then(function (response) {
